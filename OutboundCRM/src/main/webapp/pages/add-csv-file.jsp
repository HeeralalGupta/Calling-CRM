									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="text" name="assignId" value="TCI-<%= id %>" class="form-control"
														readonly/>
												</div>
											</div>											
										</div>
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number" name="minSerialNumber" class="form-control"
														placeholder="Min" />
												</div>
											</div>											
										</div>							
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input type="number" name="maxSerialNumber" class="form-control"
														placeholder="Max" />
												</div>
											</div>
										</div>
