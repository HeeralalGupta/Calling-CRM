...
public class InboundReport {
	...
	public InboundReport(Long id, Long userId, String connectionType, String callConnected, String callNotConnected,
	...
	public String toString() {
		return "InboundReport [Id=" + Id + ", userId=" + userId + ", connectionType=" + connectionType
				+ ", callConnected=" + callConnected + ", callNotConnected=" + callNotConnected + ", name=" + name
				+ ", mobile=" + mobile + ", alternateMobile=" + alternateMobile + ", email=" + email + ", profession="
				+ profession + ", gender=" + gender + ", age=" + age + ", residentialType=" + residentialType
				+ ", ruralDistrict=" + ruralDistrict + ", ruralBlock=" + ruralBlock + ", ruralPanchayat="
